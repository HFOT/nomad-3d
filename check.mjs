...
for(const id of ['nomad','ward','quorum','lex','catalyst','treasury','pip','forge','game','rush','racer','chain','type','depot','gate','assembly','vault','archive','town'])
  for(const name of ['model.js','materials.js','buildings.js','districts.js','courses.js','racers.js','words.js','groundwork.js','player-motion.js','street-furniture.js','canal-crossings.js','street-surface.js','neighborhood.js','landmarks.js','cast.js','lab.js','merge.js','viewer.js','ward.js'])
