...
export function createMaterials(){
  ...
  return {
    ivory:make('Aged warm porcelain','#d4c8a6',.2,.46,'ivory'),teal:make('Chipped rust enamel','#7c4526',.62,.43,'paint'),darkTeal:make('Deep rust trim','#3a2416',.65,.42,'paint'),
    ...
    cloth:make('Woven ochre scarf','#8a5c22',0,.98,'cloth'),clothDark:make('Ochre seams','#172335',0,1),leather:make('Weathered brown leather','#51372c',0,.82,'leather'),leatherLight:make('Backpack flap leather','#684838',0,.79,'leather'),thread:make('Linen stitching','#ae9570',0,.95),
...
export function buildRobot(M){
  ...
  root.userData={title:'CATALYST — Project builder 05',author:'CORN',units:'meters',animation:'Rigid hierarchical articulation, four baked looping clips'};
