...
for(const id of characters){
  ...
  for(const file of ['viewer.js','materials.js','buildings.js','districts.js','neighborhood.js','landmarks.js','cast.js','lab.js','merge.js','model.js','ward.js','style.css','concept.png','preview.png']){
